      ...
      <section className="flex h-full max-sm:flex-col-reverse">
        <div className="p-8 flex flex-col justify-center w-full">
          ...
          <div className="text-justify font-extralight">
            Over the past <strong>two years</strong>, I've delved into the world
            of software engineering, exploring a spectrum of technologies such
            as
            <strong>
              {" "}
              Node.js, Flutter, Firebase, Django, Django Rest Framework,
              Firebase, Socket.IO, and React.
            </strong>{" "}
            From backend systems to frontend interfaces and mobile applications,
